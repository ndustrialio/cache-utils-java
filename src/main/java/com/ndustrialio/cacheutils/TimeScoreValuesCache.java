...
public class TimeScoreValuesCache extends TimeScoreCache
{
    ...
    public Value<String> getClosestAfter(int field_id, int window, DateTime timestamp)
    {
        return super.getClosestAfter(field_id+":"+window, timestamp, true);
    }

    public Value<String> getClosestAfter(int field_id, int window, DateTime timestamp, boolean inclusive)
    {
        return super.getClosestAfter(field_id+":"+window, timestamp, inclusive);
    }

    public Value<String> getClosestBefore(int field_id, int window, DateTime timestamp)
    {
    ...
    public Value<String> get(int field_id, int window, DateTime timestamp)
    {
